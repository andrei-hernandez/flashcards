                  ...
                  <fieldset>
                    ...
                    <div className="mt-4 space-y-4">
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="push_everything" className="block ml-3 text-sm font-medium text-gray-700">
                          Everything
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                        />
                        <label htmlFor="push_email" className="block ml-3 text-sm font-medium text-gray-700">
                          Same as email
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                        />
                        <label htmlFor="push_nothing" className="block ml-3 text-sm font-medium text-gray-700">
